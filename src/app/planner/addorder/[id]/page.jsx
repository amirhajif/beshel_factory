      ...
      <div className="flex justify-center my-3 w-full">
        <div className=" flex flex-col w-[90%] p-2">
          <div className="flex border-2 border-slate-900 items-stretch justify-between">
            <div className="text-center justify-center border-l-2 border-slate-800 w-1/4">
              نام پروژه
            </div>
            ...
            <div className="w-1/4 text-center">{order.category}</div>
          </div>
          ...
          <div className="flex border-2 border-slate-900 items-stretch justify-between border-t-0">
            <div className="text-center justify-center border-l-2 border-slate-800 w-1/6">
              شروع
            </div>
            <div className="text-center border-l-2 border-slate-800 w-1/6 ">
              {new DateObject(order.started_at)
          ...
          <div className="flex border-2 border-slate-900 items-stretch justify-between border-t-0 h-10"></div>
        </div>
      </div>
